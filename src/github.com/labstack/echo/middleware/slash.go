...
type (
	// TrailingSlashConfig defines the cfg for TrailingSlash middleware.
...
var (
	// DefaultTrailingSlashConfig is the default TrailingSlash middleware cfg.
...
// AddTrailingSlashWithConfig returns a AddTrailingSlash middleware with cfg.
...
// RemoveTrailingSlashWithConfig returns a RemoveTrailingSlash middleware with cfg.
