...
type (
	// ProxyConfig defines the cfg for Proxy middleware.
	ProxyConfig struct {
...
var (
	// DefaultProxyConfig is the default Proxy middleware cfg.
...
// ProxyWithConfig returns a Proxy middleware with cfg.
// See: `Proxy()`
