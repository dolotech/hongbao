...
type (
	// StaticConfig defines the cfg for Static middleware.
	StaticConfig struct {
...
var (
	// DefaultStaticConfig is the default Static middleware cfg.
...
// StaticWithConfig returns a Static middleware with cfg.
// See `Static()`.
