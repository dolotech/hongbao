...
type (
	// BodyLimitConfig defines the cfg for BodyLimit middleware.
...
var (
	// DefaultBodyLimitConfig is the default BodyLimit middleware cfg.
...
// BodyLimitWithConfig returns a BodyLimit middleware with cfg.
// See: `BodyLimit()`.
