...
// RedirectConfig defines the cfg for Redirect middleware.
...
// DefaultRedirectConfig is the default Redirect middleware cfg.
...
// HTTPSRedirectWithConfig returns an HTTPSRedirect middleware with cfg.
// See `HTTPSRedirect()`.
...
// HTTPSWWWRedirectWithConfig returns an HTTPSRedirect middleware with cfg.
...
// HTTPSNonWWWRedirectWithConfig returns an HTTPSRedirect middleware with cfg.
...
// WWWRedirectWithConfig returns an HTTPSRedirect middleware with cfg.
// See `WWWRedirect()`.
...
// NonWWWRedirectWithConfig returns an HTTPSRedirect middleware with cfg.
// See `NonWWWRedirect()`.
