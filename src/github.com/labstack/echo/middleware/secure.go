...
type (
	// SecureConfig defines the cfg for Secure middleware.
	SecureConfig struct {
...
var (
	// DefaultSecureConfig is the default Secure middleware cfg.
...
// SecureWithConfig returns a Secure middleware with cfg.
// See: `Secure()`.
