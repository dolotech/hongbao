...
type (
	// MethodOverrideConfig defines the cfg for MethodOverride middleware.
...
var (
	// DefaultMethodOverrideConfig is the default MethodOverride middleware cfg.
...
// MethodOverrideWithConfig returns a MethodOverride middleware with cfg.
// See: `MethodOverride()`.
