...
type (
	// RewriteConfig defines the cfg for Rewrite middleware.
...
var (
	// DefaultRewriteConfig is the default Rewrite middleware cfg.
...
// RewriteWithConfig returns a Rewrite middleware with cfg.
// See: `Rewrite()`.
