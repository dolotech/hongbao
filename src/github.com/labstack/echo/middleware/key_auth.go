...
type (
	// KeyAuthConfig defines the cfg for KeyAuth middleware.
...
var (
	// DefaultKeyAuthConfig is the default KeyAuth middleware cfg.
...
// KeyAuthWithConfig returns an KeyAuth middleware with cfg.
// See `KeyAuth()`.
